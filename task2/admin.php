...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="http://localhost/company_project/task2/admin.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-dashboard"></i>  My Dashboard</a>
    <a href="http://localhost/company_project/task2/banner.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-users fa-fw"></i>  Banner Section</a>
  ...
  <div class="w3-container">
    ...
    <ul class="w3-ul w3-card-4 w3-white">
      <li class="w3-padding-16">
        <img src="images/pic-1.png" class="w3-left w3-circle w3-margin-right" style="width:35px">
        <span class="w3-xlarge">Mike</span><br>
      </li>
      <li class="w3-padding-16">
        <img src="images/pic-2.png" class="w3-left w3-circle w3-margin-right" style="width:35px">
        <span class="w3-xlarge">Jill</span><br>
      </li>
      <li class="w3-padding-16">
        <img src="images/pic-3.png" class="w3-left w3-circle w3-margin-right" style="width:35px">
  ...
  <div class="w3-container">
    ...
    <div class="w3-row">
      <div class="w3-col m2 text-center">
        <img class="w3-circle" src="images/pic-1.png" style="width:96px;height:96px">
      </div>
    ...
    <div class="w3-row">
      <div class="w3-col m2 text-center">
        <img class="w3-circle" src="images/pic-2.png" style="width:96px;height:96px">
      </div>
      <div class="w3-col m10 w3-container">
