...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a style="text-decoration: none;" href="http://localhost/company_project/task2/banner_tbl.php"> <span class="w3-bar-item w3-button w3-padding w3-blue admin-table-txt"><i class="fa-solid fa-table"></i> Banner Table</span></a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <tr>
    <th>First Heading Banner</th>
    <th>Second Heading Banner</th>
    <th colspan="2">Operators</th>
  </tr>
  <tr>
    <td>First Heading Banner</td>
    <td>Second Heading Banner</td>
    <td class="cofee_edit_btn"><a href="http://localhost/company_project/task2/banner_edit.php"><i class="fa-regular fa-pen-to-square"></i></a></td>
    <td class="cofee_delete_btn"><a href="#"><i class="fa-solid fa-trash"></i></a></td>
  </tr>
</table>
</div>
